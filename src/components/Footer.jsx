  ...
  return (
    <footer id="footer" className="footer">
      <section className="footer__left">
        <h2 className="footer__logo">Castaway</h2>
      ...
      <nav className="footer__center">
        ...
        <a href="#episodes" className="footer__nav-link">
          Episodes
        </a>
      ...
      <section className="footer__powered">
        <p className="footer__powered-text">Powered by Webflow</p>
        <div className="footer__platform-icons">
          <img
            src={spotify}
            alt="Spotify Icon"
